        ...
        $(
            ...
            impl Index<usize> for $target {
                ...
                fn index (&self, idx: usize) -> &Self::Output {
                    match idx {
                        0..$len => unsafe { self.get_unchecked(idx) },
            ...
            impl IndexMut<usize> for $target {
                ...
                fn index_mut (&mut self, idx: usize) -> &mut Self::Output {
                    match idx {
                        0..$len => unsafe { self.get_mut_unchecked(idx) },
                        _ => panic!("Index out of bounds")
                    }
                }
            }
...
impl_generic!(
    f32x2, f32, 2, f32x4, f32, 4, f32x6, f32, 6, f32x8, f32, 8, f32x10, f32, 10, f32x12, f32, 12,
    f32x14, f32, 14, f32x16, f32, 16, f64x2, f64, 2, f64x4, f64, 4, f64x6, f64, 6, f64x8, f64, 8,
    f64x10, f64, 10, f64x12, f64, 12, f64x14, f64, 14, f64x16, f64, 16
);

impl_clone!(f32x2, f32, 2, f32x4, f32, 4, f64x2, f64, 2);
